    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-black">Welcome back</h2>
          <p className="mt-2 text-sm text-gray-700">Sign in to your account to continue</p>
        </div>
        ...
        <div className="bg-white py-8 px-6 shadow-xl rounded-xl border border-gray-300">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-700">
              ...
              <Link to="/register" className="font-medium text-black hover:text-gray-700 transition-colors duration-200">
                Sign up here
              </Link>
            </p>
          </div>
